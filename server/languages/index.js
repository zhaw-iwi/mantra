 ...
 * @return
 */
var getCompilationOutputArray = function (aLanguage, aCompilerOutput) {
  let props = languageProperties[aLanguage];
...
module.exports = {
  ...
  getCompilationOutputArray: getCompilationOutputArray,
